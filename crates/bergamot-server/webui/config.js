...
var Config = (new function($)
{
	...
	{
		$('#ConfigReloadTitle').text('Shutdown Bergamot');
		...
		$ScriptTable.fasttable(
			{
				...
				infoEmpty: 'No scripts found. If you just changed option "ScriptDir", save settings and reload Bergamot.',
				pageSize: 1000
			});
...
var ConfigBackupRestore = (new function($)
{
	...
	this.backupSettings = function()
	{
		...
		var filename = 'bergamot-' + datestr + '.conf';
		...
		if (!Util.saveToLocalFile(settings, "text/plain;charset=utf-8", filename))
		{
			alert('Unfortunately your browser doesn\'t support access to local file system.\n\n'+
				'To backup settings you can manually save file "bergamot.conf" (' +
	...
	function restoreFromFile(file)
	{
		...
		reader.onload = function (event)
		{
			...
			{
				alert('File ' + filename + ' is not a valid Bergamot backup.');
				return;
			}
