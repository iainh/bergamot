...
impl Config {
    pub fn from_raw(raw: HashMap<String, String>) -> Self {
        ...
        let log_file = raw
            .get("LogFile")
            .map(PathBuf::from)
            .unwrap_or_else(|| dest_dir.join("bergamot.log"));
        ...
        let post_strategy = raw
            ...
            .map(|value| match value.to_lowercase().as_str() {
                "balanced" => bergamot_core::models::PostStrategy::Balanced,
                "rocket" => bergamot_core::models::PostStrategy::Rocket,
                "aggressive" => bergamot_core::models::PostStrategy::Aggressive,
                _ => bergamot_core::models::PostStrategy::Sequential,
            })
            .unwrap_or_default();
...
mod tests {
    ...
    fn post_strategy_parses_from_config() {
        ...
        assert_eq!(
            ...
            bergamot_core::models::PostStrategy::Rocket
        );
    }
    ...
    fn post_strategy_defaults_to_sequential() {
        ...
        assert_eq!(
            config.post_strategy,
            bergamot_core::models::PostStrategy::Sequential
        );
    }
    ...
    fn post_strategy_case_insensitive() {
        ...
        assert_eq!(
            config.post_strategy,
            bergamot_core::models::PostStrategy::Aggressive
        );
    }
}
